...
import { checkConnection, createEntry, donateEntry, withdrawEntry, listIds, getCount } from "../lib.js/stellar.js";

const meta = {
    number: 14,
    title: "Donation / Fundraising System",
    style: "warm-minimal",
    label: "campaign",
    writeAction: "create",
    updateAction: "donate",
