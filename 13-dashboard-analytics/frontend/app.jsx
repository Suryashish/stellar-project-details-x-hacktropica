...
import { checkConnection, logEntry, analyzeEntry, exportEntry, listIds, getCount } from "../lib.js/stellar.js";
...
export default function App() {
    ...
    const onWrite = () => runAction(async () => logEntry(payload()));
