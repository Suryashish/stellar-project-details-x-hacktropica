...
import { checkConnection, sendEntry, receiveEntry, tipEntry, listIds, getCount } from "../lib.js/stellar.js";
...
export default function App() {
    ...
    const onWrite = () => runAction(async () => sendEntry(payload()));
