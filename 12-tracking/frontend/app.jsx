...
import { checkConnection, updateEntry, monitorEntry, reportEntry, listIds, getCount } from "../lib.js/stellar.js";
...
export default function App() {
    ...
    const onWrite = () => runAction(async () => updateEntry(payload()));
