...
import { checkConnection, createEntry, triggerEntry, subscribeEntry, listIds, getCount } from "../lib.js/stellar.js";

const meta = {
    number: 23,
    title: "Geo-based Alert System",
    style: "map-overlay",
    label: "alert",
    writeAction: "create",
